    ...
    public class Cbi_DealingHandController : Controller
    {
        ...
        public async Task<IActionResult> ViewOfficerListForGivenProposal(string id)
        {
            ...
            try
            {
                ...
                var response = await _httpClient.GetAsync($"{BaseUrl}CBI_DealingHand/OfficerDetailWithFeebbackOf_CBI?id={Uri.EscapeDataString(id)}");
        ...
        public async Task<IActionResult> FeebbackOfCBIGetById(string id)
        {
            ...
            try
            {
                ...
                var response = await _httpClient.GetAsync($"{BaseUrl}CBI_DealingHand/FeebbackOfCBIGetById?id={Uri.EscapeDataString(id)}");
        ...
        public async Task<int> SaveCBIAdverseCommentDetails(CBIAdverseCommentViewModel objmodel)
        {
            try
            {
                ...
                var requestUrl = $"{BaseUrl}CBI_DealingHand/FeebbackOf_CBI";
